...
import 'package:in_time/time_set_feature/presentation/screens/dialogs_screen/dlg_numeral_items/bloc_add_numeral_items/bloc_add_numeral_items_bloc.dart';
...
Future<ResultAddDialog> showDialogAddMultipleItems(BuildContext context) async {
  return await showDialog(
    ...
    builder: (context) {
      return BlocProvider(
          create: (context) => sl<AddNumeralItemsBloc>()..add(const AddNumeralItemsEvent.started()),
          child: const BodyMultipleItemDialog());
    },
  );
}
